...
export async function generateMetadata({ params }: BrandPageProps) {
  ...
  return {
    title: `${brand.name} Error Codes & Diagnostics - ErrorCodeWiki`,
    description: brand.description || `Database of error codes, fault messages, and solutions for ${brand.name} equipment.`,
  };
}
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 pt-4">
        ...
        <div className="my-6 space-y-4">
          <h2 className="font-serif text-lg font-bold text-gray-900 border-b border-gray-200 pb-2">
            {brand.name} Articles & Diagnostic Guides
          </h2>
