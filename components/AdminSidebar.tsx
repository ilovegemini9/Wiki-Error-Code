...
import { LayoutDashboard, FileText, Sparkles, FileClock, CheckCircle2, FolderTree, Tag, Search, Settings, User, LogOut, FileUp, Globe, BarChart3 } from 'lucide-react';
...
export function AdminSidebar() {
  ...
  const navItems = [
    ...
    { label: 'Settings', href: '/admin/settings', icon: Settings }, { label: 'Profile', href: '/admin/profile', icon: User },
  ];
